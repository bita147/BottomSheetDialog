...
public class BottomSheetMenuListAdapter extends RecyclerView.Adapter<BottomSheetMenuListAdapter.Holder> {
    private Context context;
    private List<MenuDTO> listMenu;
    private OnMenuItemTapped tapListener;
    private BottomListMenu bottomMenu;

    public BottomSheetMenuListAdapter(Context context, BottomListMenu bottomMenu, List<MenuDTO> listMenu, OnMenuItemTapped tapListener) {
    ...
    @Override
    public BottomSheetMenuListAdapter.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.row_menu_item_list, null, false);
    ...
    @Override
    public void onBindViewHolder(BottomSheetMenuListAdapter.Holder holder, int position) {
